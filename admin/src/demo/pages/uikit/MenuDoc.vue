...
interface MegaMenuItem {
    label: string;
    icon?: string;
    items?: MegaMenuItem[][] | MegaMenuItem[];
}
...
const breadcrumbHome = ref<{ icon: string; to: string }>({ icon: 'pi pi-home', to: '/' });
const breadcrumbItems = ref<MenuItem[]>([{ label: 'Computer' }, { label: 'Notebook' }, { label: 'Accessories' }, { label: 'Backpacks' }, { label: 'Item' }]);
...
const megamenuItems = ref<MegaMenuItem[]>([
    {
        label: 'Fashion',
...
function onContextRightClick(event: MouseEvent) {
