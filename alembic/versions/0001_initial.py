...
def upgrade() -> None:
    ...
    if bind.dialect.name != "postgresql":
        raise RuntimeError("initial migration requires PostgreSQL")
    # Community relevance search depends on trigram operator classes. Missing
    # extension privileges must abort the baseline instead of omitting search.
    ...
    op.create_table(
        ...
        sa.Column("provider_key", sa.String(length=64), nullable=False),
        sa.Column("owner_subject_id", sa.String(length=200), nullable=True),
        sa.Column("bucket", sa.String(length=200), nullable=True),
        sa.Column("object_key", sa.String(length=500), nullable=False),
    ...
    op.create_index(
        op.f("ix_assets_upload_intents_owner_subject_id"),
        "assets_upload_intents",
        ["owner_subject_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "status IN ('pending', 'published', 'rejected', 'deleted')", name="ck_comments_status"
        ),
    ...
    op.create_table(
        ...
        sa.Column("locked_by_type", sa.String(length=64), nullable=True),
        sa.Column("locked_by_id", sa.String(length=200), nullable=True),
        sa.Column("first_post_id", sa.Uuid(), nullable=True),
        ...
        sa.CheckConstraint(
            ...
            "AND first_post_id IS NOT NULL AND last_post_id IS NOT NULL "
        ...
        sa.CheckConstraint("reply_count >= 0", name="ck_community_discussions_reply_count"),
        sa.CheckConstraint("version >= 1", name="ck_community_discussions_version"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("template_key", "slug", name="uq_community_discussions_template_slug"),
    )
    op.create_index(
        op.f("ix_community_discussions_author_id"),
        "community_discussions",
        ["author_id"],
        unique=False,
    )
    op.create_index(
        ...
        "community_discussions",
        ["status", "last_posted_at", "id"],
        unique=False,
    )
    op.create_index(
        "ix_community_discussions_newest",
        "community_discussions",
        ["status", "created_at", "id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_community_discussions_status"), "community_discussions", ["status"], unique=False
    )
    op.create_index(
        "ix_community_discussions_top",
        "community_discussions",
        ["status", "reply_count", "last_posted_at", "id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "scope", "idempotency_key_digest", name="uq_community_idempotency_scope_key"
        ),
    )
    op.create_index(
        "ix_community_idempotency_created",
        "community_idempotency_records",
        ["created_at"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint("kind IN ('primary', 'secondary')", name="ck_community_tags_kind"),
        sa.CheckConstraint("status IN ('active', 'archived')", name="ck_community_tags_status"),
        sa.CheckConstraint("position >= 0", name="ck_community_tags_position"),
        sa.CheckConstraint("version >= 1", name="ck_community_tags_version"),
        sa.ForeignKeyConstraint(["parent_id"], ["community_tags.id"], ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("slug"),
    )
    op.create_index(
        "ix_community_tags_parent_position",
        "community_tags",
        ["kind", "parent_id", "position", "name", "id"],
        unique=False,
    )
    op.create_table(
        "contents",
    ...
    op.create_index(
        op.f("ix_engagement_content_likes_content_id"),
        "engagement_content_likes",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_engagement_content_likes_subject_id"),
        "engagement_content_likes",
        ["subject_id"],
        unique=False,
    )
    op.create_index(
        "ix_engagement_like_active",
        "engagement_content_likes",
        ["content_id", "removed_at"],
        unique=False,
    )
    op.create_table(
        "engagement_content_ratings",
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column("subject_type", sa.String(length=32), nullable=False),
        sa.Column("subject_id", sa.String(length=200), nullable=False),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint("rating >= 1 AND rating <= 5", name="ck_engagement_rating_range"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        op.f("ix_engagement_content_ratings_content_id"),
        "engagement_content_ratings",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_engagement_content_ratings_subject_id"),
        "engagement_content_ratings",
        ["subject_id"],
        unique=False,
    )
    op.create_table(
        "engagement_content_stats",
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column("type_name", sa.String(length=64), nullable=False),
        ...
        sa.Column("rating_average", sa.Numeric(precision=4, scale=1), nullable=True),
        sa.Column("projection_version", sa.Integer(), nullable=False),
        sa.Column("projected_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint("like_count >= 0", name="ck_engagement_stats_like_count"),
        sa.CheckConstraint("rating_count >= 0", name="ck_engagement_stats_rating_count"),
        sa.CheckConstraint("rating_sum >= 0", name="ck_engagement_stats_rating_sum"),
        sa.CheckConstraint("view_count >= 0", name="ck_engagement_stats_view_count"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("content_id"),
    )
    op.create_index(
        op.f("ix_engagement_content_stats_type_name"),
        "engagement_content_stats",
        ["type_name"],
        unique=False,
    )
    op.create_index(
        "ix_engagement_stats_sort",
        "engagement_content_stats",
        ["content_status", "published_at", "content_id"],
        unique=False,
    )
    op.create_table(
        "engagement_content_views",
        sa.Column("content_id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_engagement_content_views_content_id"),
        "engagement_content_views",
        ["content_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("field_slug", sa.String(length=100), nullable=False),
        sa.Column("schema_version", sa.String(length=32), nullable=False),
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("group_key", "field_slug", name="uq_settings_values_group_field"),
    )
    op.create_index("ix_settings_values_group_key", "settings_values", ["group_key"], unique=False)
    op.create_table(
        "taxonomy_dimensions",
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["discussion_id"], ["community_discussions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["tag_id"], ["community_tags.id"], ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("discussion_id", "tag_id", name="uq_community_discussion_tags_pair"),
    )
    op.create_index(
        "ix_community_discussion_tags_discussion",
        "community_discussion_tags",
        ["discussion_id", "position", "tag_id"],
        unique=False,
    )
    op.create_index(
        "ix_community_discussion_tags_tag",
        "community_discussion_tags",
    ...
    op.create_table(
        ...
        sa.Column("author_id", sa.String(length=200), nullable=False),
        sa.Column("body", sa.Text(), nullable=False),
        sa.Column("body_profile", sa.String(length=32), nullable=False),
        sa.Column("schema_version", sa.String(length=32), nullable=False),
        sa.Column("data", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column("version", sa.Integer(), nullable=False),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint("post_type = 'comment'", name="ck_community_posts_type"),
        sa.CheckConstraint(
            "status IN ('pending', 'published', 'hidden', 'deleted')",
            name="ck_community_posts_status",
        ),
        sa.CheckConstraint("number >= 1", name="ck_community_posts_number"),
        sa.CheckConstraint("version >= 1", name="ck_community_posts_version"),
        sa.ForeignKeyConstraint(
            ["discussion_id"], ["community_discussions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("discussion_id", "number", name="uq_community_posts_discussion_number"),
    )
    op.create_index(
        op.f("ix_community_posts_author_id"), "community_posts", ["author_id"], unique=False
    )
    op.create_index(
        "ix_community_posts_public_stream",
        "community_posts",
        ["discussion_id", "status", "number", "id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("search_profile", sa.String(length=32), nullable=False),
        sa.Column("normalized_text", sa.Text(), nullable=False),
        sa.Column("source_version", sa.Integer(), nullable=False),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint("document_kind IN ('title', 'post')", name="ck_community_search_kind"),
        sa.CheckConstraint("source_version >= 1", name="ck_community_search_source_version"),
        sa.ForeignKeyConstraint(
            ["discussion_id"], ["community_discussions.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "ix_community_search_discussion_kind",
        "community_search_documents",
        ["discussion_id", "document_kind"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        ...
        ["post_id"],
        unique=True,
        postgresql_where=sa.text("document_kind = 'post'"),
        sqlite_where=sa.text("document_kind = 'post'"),
    )
    op.create_index(
        ...
        ["discussion_id"],
        unique=True,
        postgresql_where=sa.text("document_kind = 'title'"),
        sqlite_where=sa.text("document_kind = 'title'"),
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_notification_delivery_attempts_delivery_id"),
        "notification_delivery_attempts",
        ["delivery_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "bucket_type IN ('perpetual', 'expiring')", name="ck_points_buckets_type_valid"
        ),
        sa.CheckConstraint("amount >= 0", name="ck_points_buckets_amount_nonneg"),
        sa.ForeignKeyConstraint(["account_id"], ["points_accounts.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(
        ...
        sqlite_where=sa.text("bucket_type = 'expiring'"),
    )
    op.create_index(
        ...
        sqlite_where=sa.text("bucket_type = 'perpetual'"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["entry_id"], ["points_ledger_entries.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "uq_community_search_title_document",
        table_name="community_search_documents",
        postgresql_where=sa.text("document_kind = 'title'"),
        sqlite_where=sa.text("document_kind = 'title'"),
    )
    op.drop_index(
    ...
    op.drop_index("ix_community_search_discussion_kind", table_name="community_search_documents")
    ...
    op.drop_index("ix_community_posts_public_stream", table_name="community_posts")
    op.drop_index(op.f("ix_community_posts_author_id"), table_name="community_posts")
    op.drop_table("community_posts")
    op.drop_index("ix_community_discussion_tags_tag", table_name="community_discussion_tags")
    op.drop_index("ix_community_discussion_tags_discussion", table_name="community_discussion_tags")
    op.drop_table("community_discussion_tags")
    ...
    op.drop_index("ix_settings_values_group_key", table_name="settings_values")
    ...
    op.drop_index(
        op.f("ix_engagement_content_views_content_id"), table_name="engagement_content_views"
    )
    op.drop_table("engagement_content_views")
    op.drop_index("ix_engagement_stats_sort", table_name="engagement_content_stats")
    op.drop_index(
        op.f("ix_engagement_content_stats_type_name"), table_name="engagement_content_stats"
    )
    op.drop_table("engagement_content_stats")
    op.drop_index(
        op.f("ix_engagement_content_ratings_subject_id"), table_name="engagement_content_ratings"
    )
    op.drop_index(
        op.f("ix_engagement_content_ratings_content_id"), table_name="engagement_content_ratings"
    )
    op.drop_table("engagement_content_ratings")
    op.drop_index("ix_engagement_like_active", table_name="engagement_content_likes")
    op.drop_index(
        op.f("ix_engagement_content_likes_subject_id"), table_name="engagement_content_likes"
    )
    op.drop_index(
        op.f("ix_engagement_content_likes_content_id"), table_name="engagement_content_likes"
    )
    op.drop_table("engagement_content_likes")
    ...
    op.drop_index("ix_community_tags_parent_position", table_name="community_tags")
    op.drop_table("community_tags")
    op.drop_index("ix_community_idempotency_created", table_name="community_idempotency_records")
    op.drop_table("community_idempotency_records")
    op.drop_index("ix_community_discussions_top", table_name="community_discussions")
    op.drop_index(op.f("ix_community_discussions_status"), table_name="community_discussions")
    op.drop_index("ix_community_discussions_newest", table_name="community_discussions")
    op.drop_index("ix_community_discussions_latest", table_name="community_discussions")
    op.drop_index(op.f("ix_community_discussions_author_id"), table_name="community_discussions")
    ...
    op.drop_index(
        op.f("ix_assets_upload_intents_owner_subject_id"), table_name="assets_upload_intents"
    )
