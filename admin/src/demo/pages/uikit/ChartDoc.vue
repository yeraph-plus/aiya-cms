...
const lineData = ref<ChartLike>();
const pieData = ref<ChartLike>();
const polarData = ref<ChartLike>();
const barData = ref<ChartLike>();
const radarData = ref<ChartLike>();
const lineOptions = ref<ChartOptionsLike>();
const pieOptions = ref<ChartOptionsLike>();
const polarOptions = ref<ChartOptionsLike>();
const barOptions = ref<ChartOptionsLike>();
const radarOptions = ref<ChartOptionsLike>();
