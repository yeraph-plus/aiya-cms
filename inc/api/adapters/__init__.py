"""Composition-root-side adapter library.
...
pick implementations explicitly per manifest. Placeholders for planned
integrations declare their target Port and stay side-effect free until
implemented.
"""

from inc.api.adapters.registry import (
