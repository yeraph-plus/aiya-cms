...
type InventoryStatus = string | { label: string; value: string };
...
const selectedProducts = ref<Product[] | null>(null);
const filters = ref<DataTableFilterMeta>({
    global: { value: null, matchMode: FilterMatchMode.CONTAINS }
});
const globalFilter = computed<string | null>({
    get: () => (filters.value['global'] as DataTableFilterMetaData).value as string | null,
    set: (value) => {
        (filters.value['global'] as DataTableFilterMetaData).value = value;
    }
});
...
function saveProduct() {
    ...
    if (product?.value.name?.trim()) {
        if (product.value.id) {
            product.value.inventoryStatus = product.value.inventoryStatus && typeof product.value.inventoryStatus === 'object' ? product.value.inventoryStatus.value : product.value.inventoryStatus;
            ...
            product.value.inventoryStatus = product.value.inventoryStatus && typeof product.value.inventoryStatus === 'object' ? product.value.inventoryStatus.value : 'INSTOCK';
