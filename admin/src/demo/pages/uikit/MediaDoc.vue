...
import { PhotoService, type Photo } from '@/demo/services/PhotoService';
import { ProductService, type Product } from '@/demo/services/ProductService';
import { onMounted, ref } from 'vue';

const products = ref<Product[]>([]);
const images = ref<Photo[]>([]);
const galleriaResponsiveOptions = ref<{ breakpoint: string; numVisible: number }[]>([
    {
        breakpoint: '1024px',
        numVisible: 5
    },
...
const carouselResponsiveOptions = ref<{ breakpoint: string; numVisible: number; numScroll: number }[]>([
    {
        breakpoint: '1024px',
        numVisible: 3,
        numScroll: 3
