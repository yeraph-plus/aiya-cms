...
class ManagementRetentionActivity:
    """Clean audit and kernel execution history when site cleanup is disabled."""
    ...
    async def __call__(self, uow: UnitOfWork, data: dict[str, Any], ctx: Any) -> dict[str, int]:
        ...
        get_logger("management.retention").info(
            "management retention cleanup completed",
            retention_days=days,
...
__all__ = ["ManagementRetentionActivity"]
