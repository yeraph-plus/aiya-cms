"""Taxonomy capability statistics provider."""

from __future__ import annotations

from typing import Any

from inc.capabilities.taxonomy.models import TaxonomyTerm
...
async def stat(*, uow_factory: Any, now: Any, window_days: int = 7) -> dict[str, Any]:
    return await count_created(
        uow_factory=uow_factory, model=TaxonomyTerm, now=now, window_days=window_days
    )
